...
export const restaurants: Restaurant[] = [
  albaicin({
    ...
    website: 'https://granadamap.com/es/torcuato', tags: ['Tradicional', 'Tapas', 'Terraza'],
  }),
  albaicin({
    ...
    website: 'https://losmascarones.com/', tags: ['Tradicional', 'Tapas', 'Cocina casera'],
  }),
  albaicin({
    ...
    website: 'https://turismo.granada.org/es/empresas/restaurantes/bar-aliatar-caracoles', tags: ['Caracoles', 'Tradicional', 'Familiar'],
  }),
  albaicin({
    ...
    website: 'https://www.casagabrielgranada.com/', tags: ['Brasas', 'Carnes', 'Reserva'],
  }),
  albaicin({
    ...
    website: 'https://aixa.bar/', schedule: 'De 7:00 a 24:00. Cerrado lunes y martes.', tags: ['Tapas', 'Terraza', 'Pizza'],
  }),
  albaicin({
    ...
    website: 'https://www.cafe4gatos.com/', tags: ['Desayuno', 'Vistas', 'Vegetariano'],
  }),
  albaicin({
    ...
    website: 'https://www.estrellasdesannicolas.com/', tags: ['Vistas', 'Terraza', 'Cena especial'],
  }),
  albaicin({
    ...
    website: 'https://www.facebook.com/ElHigoGranada/', tags: ['Patio', 'Tapas', 'Vegano'],
  }),
  albaicin({
    ...
    website: 'https://abenhumeya.com/', tags: ['Vistas', 'Romántico', 'Reserva'],
  }),
  albaicin({
    ...
    website: 'https://www.carmenmiradordeaixa.com/es', tags: ['Vistas', 'Celebraciones', 'Reserva'],
  }),
  albaicin({
    ...
    website: 'https://miradordemorayma.com/', schedule: 'Apertura habitual de martes a sábado; conviene consultar antes de ir.', tags: ['Vistas', 'Andaluza', 'Terraza'],
  }),
  albaicin({
    ...
    website: 'https://www.elhuertodejuanranas.com/', tags: ['Vistas', 'Terraza', 'Romántico'],
  }),
  albaicin({
    ...
    website: 'https://www.restauranteelagua.es/es', tags: ['Vistas', 'Fusión', 'Reserva'],
  }),
  albaicin({
    ...
    website: 'https://www.restaurante-eltrillo.com/', tags: ['Jardín', 'Mediterránea', 'Reserva'],
  }),
  albaicin({
    ...
    website: 'https://restaurantearrayanesgranada.com/', tags: ['Halal', 'Marroquí', 'Vegetariano'],
  }),
  albaicin({
    ...
    website: 'https://www.casapasteles.es/', tags: ['Desayuno', 'Dulces', 'Histórico'],
  }),
  ...
  granada({
    ...
    website: 'https://sanchocasualburger.com/', tags: ['Hamburguesas', 'Vegetariano', 'Familias'],
  }),
  granada({
    ...
    website: 'https://www.maesepio.com/', tags: ['Arroces', 'Grupos', 'Reserva'],
  }),
  granada({
    ...
    website: 'https://lumbrebymoma.es/', schedule: 'De 12:00 a 18:00 y de 20:00 a 00:00; consulta posibles cambios.', tags: ['Contemporánea', 'Carnes', 'Pescado'],
  }),
  granada({
    ...
    website: 'https://bodegascastaneda.eatbu.com/?lang=es', schedule: 'Horario oficial publicado: de 11:30 a 01:00; consulta posibles cambios.', tags: ['Taberna', 'Tapas', 'Vinos'],
  }),
  granada({
    ...
    website: 'https://irreverentegranada.com/', tags: ['Moderno', 'Merienda', 'Reserva'],
  }),
  granada({
    ...
    website: 'https://www.instagram.com/entrebrasas/', schedule: 'Apertura habitual de martes a sábado en servicios de mediodía y noche.', tags: ['Brasas', 'Tapas', 'Reserva'],
  }),
  granada({
    ...
    website: 'https://losdiamantes.es/ubicaciones/', tags: ['Pescado', 'Tapas', 'Sin reserva'],
  }),
  granada({
    ...
    website: 'https://rosariovarela.es/', tags: ['Moderno', 'Terraza', 'Noche'],
  }),
  granada({
    ...
    website: 'https://www.tripadvisor.es/Restaurant_Review-g187441-d5530208-Reviews-Bar_Patio_Braserito-Granada_Province_of_Granada_Andalucia.html', tags: ['Tradicional', 'Vinos', 'Temporada'],
  }),
  granada({
    ...
    website: 'https://avilayavilatapas.eatbu.com/?lang=es', tags: ['Tapas', 'Jamón asado', 'Económico'],
  }),
  granada({
    ...
    website: 'https://www.barprovincias.es/', tags: ['Histórico', 'Tapas', 'Pescado'],
  }),
  granada({
    ...
    website: 'https://www.tripadvisor.es/Restaurant_Review-g187441-d7277584-Reviews-or15-Sitarilla-Granada_Province_of_Granada_Andalucia.html', tags: ['Tapas', 'Económico', 'Casero'],
  }),
  granada({
    ...
    website: 'https://www.bar-aliatar.es/', tags: ['Bocadillos', 'Histórico', 'Informal'],
  }),
  granada({
    ...
    website: 'https://turismo.granada.org/es/empresas/restaurantes/rincon-rodri', tags: ['Marisco', 'Pescado', 'Reserva'],
  }),
  granada({
    ...
    website: 'https://www.poetasandaluces.es/', tags: ['Asador', 'Grupos', 'Celebraciones'],
  }),
  granada({
    ...
    website: 'https://rincondelpoeta.eatbu.com/?lang=es', schedule: 'Cerrado los miércoles; consulta el horario del resto de la semana.', tags: ['Terraza', 'Grupos', 'Tapas'],
  }),
  granada({
    ...
    website: 'https://www.google.com/maps/search/?api=1&query=La+Macetilla+Granada', tags: ['Jamón asado', 'Tradicional', 'Acogedor'],
  }),
  granada({
    ...
    website: 'https://restaurantemexicanogranada.com/', tags: ['Mexicano', 'Cócteles', 'Informal'],
  }),
  granada({
    ...
    website: 'https://losmanueles.es/', schedule: 'Cocina habitualmente de 12:00 a 00:00; consulta posibles cambios.', tags: ['Histórico', 'Andaluza', 'Croquetas'],
  }),
  granada({
    ...
    website: 'https://turismo.granada.org/en/mercado-san-agustin-gourmet', tags: ['Mercado', 'Variedad', 'Grupos'],
  }),
  granada({
    ...
    website: 'https://www.tripadvisor.es/Restaurant_Review-g187441-d23699518-Reviews-Casa_Rafa_Granada-Granada_Province_of_Granada_Andalucia.html', tags: ['Pescado', 'Arroces', 'Terraza'],
  }),
];

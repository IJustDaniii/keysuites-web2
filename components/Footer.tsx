...
export function Footer() {
  return <footer className="site-footer">
    <div className="footer-main section-shell">
      <div className="footer-brand"><Link className="footer-logo" href="/" aria-label="OKEY SUITES, inicio"><Image src="/key-suites-logo-white.png" alt="OKEY SUITES" width={210} height={80} /></Link><p>{siteContent.footer.description}</p></div>

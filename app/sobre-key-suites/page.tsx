...
export default function AboutPage() {
  ...
  return <main className="about-page">
    ...
    <section className="simple-cta section-shell"><span>{copy.ctaLabel}</span><h2>{copy.ctaTitle}</h2><Link className="primary-button" href="/alojamientos">{copy.ctaButton} <b>→</b></Link></section>
  </main>;
}
